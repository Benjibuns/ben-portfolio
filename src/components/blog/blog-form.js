...
import DropzoneComponenet from "react-dropzone-component";
...
class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://benjibuns.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  UNSAFE_componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://benjibuns.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
